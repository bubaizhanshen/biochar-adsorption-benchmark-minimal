...
PANELS = (
    ROOT
    / "reanalysis/external_sources/new_source_panels/extracted_tabulated_panels"
    / "external_shared_condition_panels.csv"
)
ANCHORS = (
    ROOT
    / "reanalysis/results/external_panel_fewshot/external_fewshot_all_anchor_sets.csv"
)
OUT = ROOT / "reanalysis/results/external_panel_fewshot"
