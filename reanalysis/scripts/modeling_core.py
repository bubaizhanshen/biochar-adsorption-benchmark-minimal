...
INPUT_DIR = ROOT / "reanalysis" / "input_data"
DEFAULT_OUT_DIR = ROOT / "reanalysis" / "results" / "model_selection_checks"
...
DATASETS = OrderedDict(
    {
        "Dataset I": DatasetConfig(
            key="HM2",
            label="Dataset I",
            file="reanalysis/input_data/HM2.xlsx",
            task_col="HM",
            target_col="Eta",
        ...
        "Dataset II": DatasetConfig(
            key="HMI_data",
            label="Dataset II",
            file="reanalysis/input_data/HMI_data.xlsx",
            task_col="Metal type",
            target_col="qe",
            group_mode="adsorbent",
            display_to_task={
        ...
        "Dataset III": DatasetConfig(
            key="EC",
            label="Dataset III",
            file="reanalysis/input_data/EC.xlsx",
            task_col="Pollutant",
            target_col="Capacity",
            group_mode="adsorbent",
            display_to_task={
...
if __name__ == "__main__":
    raise SystemExit(
        "modeling_core.py is an import-only module; use run_material_holdout.py, "
        "run_source_holdout.py, or the candidate-panel runners."
    )
